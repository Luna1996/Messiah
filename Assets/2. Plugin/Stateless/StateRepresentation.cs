...
namespace Stateless
{
    public partial class StateMachine<TState, TTrigger>
    {
        internal partial class StateRepresentation
        {
            ...
            internal ICollection<UpdateActionBehavior> UpdateActions { get; } = new List<UpdateActionBehavior>();
            ...
            public void AddUpdateAction(Action<float> action, Reflection.InvocationInfo entryActionDescription)
            {
                UpdateActions.Add(new UpdateActionBehavior.Sync(action, entryActionDescription));
            }
            ...
            public void Update(float deltaTimeInSecond)
            {
                ExecuteUpdateActions(deltaTimeInSecond);
            }
            ...
            void ExecuteUpdateActions(float deltaTimeInSecond)
            {
                foreach (var action in UpdateActions)
                    action.Execute(deltaTimeInSecond);
            }
