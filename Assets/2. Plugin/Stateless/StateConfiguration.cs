...
namespace Stateless
{
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        public partial class StateConfiguration
        {
            ...
            /// <summary>
            /// Specify an action that will execute when state update
            /// the configured state.
            /// </summary>
            /// <param name="updateAction">Action to execute.</param>
            /// <param name="updateActionDescription">Action description.</param>
            /// <returns>The receiver.</returns>
            public StateConfiguration OnUpdate(Action<float> updateAction, string updateActionDescription = null)
            {
                if (updateAction == null) throw new ArgumentNullException(nameof(updateAction));

                _representation.AddUpdateAction(
                    (deltaTimeInSecond) => updateAction(deltaTimeInSecond),
                    Reflection.InvocationInfo.Create(updateAction, updateActionDescription));
                return this;
            }
            ...
            public StateConfiguration OnEntry<TArg0>(Action<Transition, TArg0> entryAction, string entryActionDescription = null)
            {
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));
            ...
            public StateConfiguration OnEntry<TArg0, TArg1>(Action<Transition, TArg0, TArg1> entryAction, string entryActionDescription = null)
            {
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));
