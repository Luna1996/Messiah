...
namespace Stateless
{
    ...
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        private TState _stateReference;
        ...
        {
           // _stateReference = new StateReference { State = initialState };
          //  _stateAccessor = () => _stateReference.State;
            //_stateMutator = s => _stateReference.State = s;

            _stateReference = initialState;
        ...
        {
            var representativeState = GetRepresentation(State);
            representativeState.Update(deltaTimeInSecond);
        }
