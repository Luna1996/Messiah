...
namespace XLua.CSObjectWrap
{
    public class MessiahLogicCardBridge : LuaBase, Messiah.Logic.Card
    {
        ...
        System.Action Messiah.Logic.Card.onPlay 
        {
        ...
        System.Action<int> Messiah.Logic.Card.canPlay 
        {
            ...
            get 
            {
                ...
                lock (luaEnv.luaEnvLock)
                {
					...
					System.Action<int> __gen_ret = translator.GetDelegate<System.Action<int>>(L, -1);
					LuaAPI.lua_pop(L, 2);
					return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
                }
        ...
        System.Action Messiah.Logic.Card.addToHand 
        {
        ...
        System.Action Messiah.Logic.Card.rmvFrHand 
        {
